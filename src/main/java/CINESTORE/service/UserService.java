...
import CINESTORE.util.MessageFactory.Message;
...
public class UserService {
    ...
    public UserService() {
        userDAO = CinestoreApplication.jdbiConnection.onDemand(UserDAO.class);
